...
export default function App() {
  ...
  const handleWhatsAppContact = () => {
    window.open(
      "https://wa.me/2348098736884?text=Hello, I would like to schedule a free consultation for surveying services.",
      "_blank",
    )
  }
  ...
  const handleQuoteWhatsAppContact = () => {
    window.open(
      "https://wa.me/2348098736884?text=Hello, I would like to request a quote for surveying services.",
      "_blank",
    )
  }
  ...
  const handleCalendlySchedule = () => {
    window.open("https://calendly.com/remi-osoba/consultation", "_blank")
  }
